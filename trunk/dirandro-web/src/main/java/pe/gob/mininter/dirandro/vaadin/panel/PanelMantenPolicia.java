...
public class PanelMantenPolicia extends DirandroComponent implements TextChangeListener,ClickListener {
		...
		tblPolicias.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(esModoNuevo){
					...
					//TODO: No debe llamar al servicio otra vez recargas el metodo
	...
	private void cargarPolicias(List<Policia> listPolicias, boolean flagLimpiar){
		...
		for (Policia p: listPolicias){
			...
			item.getItemProperty("paterno").setValue(p.getPersona().getApePaterno());
			item.getItemProperty("materno").setValue(p.getPersona().getApeMaterno());
			item.getItemProperty("nroDocumento").setValue(p.getPersona().getNroDocumento());
			item.getItemProperty("tipoDocumento").setValue(p.getPersona().getTipoDocumento());
			item.getItemProperty("tipoDocumento.nombre").setValue(p.getPersona().getTipoDocumento().getNombre());
	...
	public void obtenerDatosPersona() {
		//TODO: Falta recorrer el id para q te pinte el combo de persona
