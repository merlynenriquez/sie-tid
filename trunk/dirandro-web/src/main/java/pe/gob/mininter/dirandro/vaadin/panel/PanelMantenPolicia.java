...
public class PanelMantenPolicia extends DirandroComponent implements TextChangeListener,ClickListener {
		...
		tblPolicias.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(esModoNuevo){
					...
					txtUnidad.setValue(item.getItemProperty("unidad").getValue());
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		txtUnidad.setCaption("Unidad");
		txtUnidad.setImmediate(false);
		txtUnidad.setWidth("-1px");
		txtUnidad.setHeight("-1px");
		txtUnidad.setRequired(true);
		verticalLayout_3.addComponent(txtUnidad);
