...
public class PanelRegistroParteInstalacion extends CustomComponent implements ClickListener {
	...
	public void postConstruct() {
		...
		List<Organizacion> lOrganizaciones = organizacionService.listarOrganizaciones();
...
//				
	...
	public void buttonClickGrabar(){
		...
		instalacion.setAlturaMt(new BigDecimal(txtAlto.getValue().toString()));
		instalacion.setAnchoMt(new BigDecimal(txtAncho.getValue().toString()));
		instalacion.setDescripcion(txtDescripcion.getValue().toString());
		...
		instalacion.setLargoMt(new BigDecimal(txtLargo.getValue().toString()));
		instalacion.setLatitud(txtLatitud.getValue().toString());
		instalacion.setLongitud(txtLongitud.getValue().toString());
		...
		instalacion.setRadio(Integer.valueOf((String)txtRadio.getValue()));
