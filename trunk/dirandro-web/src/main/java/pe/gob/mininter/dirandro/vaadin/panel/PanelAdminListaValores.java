...
public class PanelAdminListaValores extends HarecComponent implements TextChangeListener, ClickListener{
	...
	private HorizontalLayout buildPnlListaContenido() {
		...
		pnlListaContenido.setWidth("950px");
	...
	private VerticalLayout buildPnlListaFila3() {
		...
		txtDescirpcionLista.setInputPrompt("Descripción");
	...
	private HorizontalLayout buildPnlValorContenido() {
		...
		pnlValorContenido.setWidth("950px");
	...
	private VerticalLayout buildPnlValores() {
		...
		tblValores.setWidth("470px");
		tblValores.setHeight("250px");
