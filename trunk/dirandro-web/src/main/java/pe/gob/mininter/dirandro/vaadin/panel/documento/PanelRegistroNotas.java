...
/**
 * Pantalla para registrar el texto de alguno de los tipos de notas:
 * Nota de Agente
 * Nota de informacion
 ...
 *
 */
public class PanelRegistroNotas extends DirandroComponent {
	...
	private NotaAgenteService notaAgenteService;
	 ...
	 * visual editor.
	 */
	public PanelRegistroNotas(List<Opcion> acciones, String height) {
		super(acciones, height);
		
		notaAgente = new NotaAgente();
		
		notaAgenteService = Injector.obtenerServicio(NotaAgenteService.class);
	...
	public void postConstruct() {
		...
		cmbTipo.setCodigoLista(Constante.LISTA.CODIGO.TIPO_NOTA);
		cmbEstado.setCodigoLista(Constante.LISTA.CODIGO.TIPO_NOTA_ESTADOS);
		
		cmbPolicia.setInputPrompt("Policia");
		cmbPolicia.setContainerDataSource(new BeanItemContainer<Policia>(Policia.class, lstPolicias));
		cmbPolicia.setItemCaptionPropertyId("nombreCompleto");
		cmbPolicia.setImmediate(true);
		
		/*cmbPolicia.setInputPrompt("Expediente");
		cmbPolicia.setItemCaptionPropertyId("autogenerado");
	...
	private void llenaNota(){
		if(notaAgente!=null){
			...
			txtNota.setValue(notaAgente.getContenido());
			dtRegistro.setValue(notaAgente.getFechaNota());
			//cmbPolicia.select(notaInformativa.getParte());
	...
	private void guardarNota(){
		...
		//notaInformativa.setNumero(HarecUtil.nullToEmpty(txtNumero.getValue()));
		notaAgente.setContenido(HarecUtil.nullToEmpty(txtNota.getValue()));
		notaAgente.setFechaNota((Date)dtRegistro.getValue());
		//notaInformativa.setParte((Expediente) cmbExpediente.getValue() );
		
		if(notaAgente.esNuevo()){
			notaAgenteService.crear(notaAgente);
		}else{
			notaAgenteService.actualizar(notaAgente);
		}
		
		AlertDialog alertDialog = new  AlertDialog("Registro de Nota XXXXXXXXX", "Se ha registrado la Nota XXXXXXXX correctamente", "Aceptar", "400");
	...
	private VerticalLayout buildLytCuerpo() {
		...
		lytCuerpo.setComponentAlignment(horizontalLayout_4, new Alignment(20));
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		cmbPolicia.setCaption("Agente Policial");
		cmbPolicia.setImmediate(false);
		cmbPolicia.setWidth("-1px");
		cmbPolicia.setHeight("-1px");
		horizontalLayout_2.addComponent(cmbPolicia);
		
		// cmbTipo
		cmbTipo = new ComboBoxLOVS();
		cmbTipo.setCaption("Tipo de Nota");
		...
		dtRegistro.setCaption("Fecha de Nota");
		dtRegistro.setImmediate(false);
		dtRegistro.setWidth("140px");
