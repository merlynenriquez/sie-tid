...
public class PanelMantenDelito extends DirandroComponent implements ClickListener, TextChangeListener {
		...
		treeDelitos.addListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (esModoNuevo) {
					...
					Valor codigoProcesal = null;
					if (item.getItemProperty("codigoProcesal").getValue() != null) {
						codigoProcesal = new Valor();
						codigoProcesal.setId((Long)item.getItemProperty("codigoProcesal.id").getValue());
					}
					cmbTipoProcesalDelito.select(codigoProcesal);
	...
	private void cargarTipoProcesalDelito(){
		/*List<Valor> valores = valorService.obtenerLista(Constante.LISTA.CODIGO.COD_PROCESAL);
		...
		cmbTipoProcesalDelito.setContainerDataSource(bicValores);
	...
	public void buttonClick(ClickEvent event) {
		...
		if(event.getSource().equals(btnCrearDelito)){
			...
			if(event.getSource().equals(btnEliminarDelito)){
				//TODO: Faltar terminar la opcion de eliminar
			}
		}
	}
