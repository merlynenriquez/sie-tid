...
public class PanelMantenDelito extends DirandroComponent {
	...
	private VerticalLayout buildVerticalLayout_4() {
		...
		verticalLayout_4.setCaption("Administración de Delitos");
		...
		txtCodigo.setInputPrompt("Código del Delito");
		...
		cmbDelitoPadre.setCaption("Sub-Nivel");
