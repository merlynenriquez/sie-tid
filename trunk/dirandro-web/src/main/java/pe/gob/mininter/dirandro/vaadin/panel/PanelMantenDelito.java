...
public class PanelMantenDelito extends HarecComponent {
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		verticalLayout_3.setHeight("340px");
	...
	private VerticalLayout buildVerticalLayout_4() {
		...
		verticalLayout_4.setHeight("340px");
	...
	private VerticalLayout buildVerticalLayout_5() {
		...
		// txtxNombre
		txtxNombre = new TextField();
		txtxNombre.setCaption("Nombre");
		txtxNombre.setImmediate(false);
		txtxNombre.setWidth("-1px");
		txtxNombre.setHeight("-1px");
		txtxNombre.setRequired(true);
		verticalLayout_5.addComponent(txtxNombre);
