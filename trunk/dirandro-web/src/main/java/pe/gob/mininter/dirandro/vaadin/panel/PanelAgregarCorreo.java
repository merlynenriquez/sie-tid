...
public class PanelAgregarCorreo extends CustomComponent {
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		verticalLayout_2.setWidth("421px");
		verticalLayout_2.setHeight("81px");
		verticalLayout_2.setMargin(false);
		
		// textField_1
		textField_1 = new TextField();
		textField_1.setCaption("Correo");
		textField_1.setImmediate(false);
		textField_1.setWidth("410px");
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		horizontalLayout_1.setWidth("170px");
