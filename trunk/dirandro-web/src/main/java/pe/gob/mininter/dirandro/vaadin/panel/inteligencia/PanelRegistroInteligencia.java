...
public class PanelRegistroInteligencia extends DirandroComponent implements SelectedTabChangeListener {
	...
	@AutoGenerated
	private PanelRegistroInteligenciaPrincipal panelRegistroInteligenciaPrincipal_2;
...
//		}
	...
	private VerticalLayout buildTabDocumento() {
		...
		// panelRegistroInteligenciaPrincipal_2
		panelRegistroInteligenciaPrincipal_2 = new PanelRegistroInteligenciaPrincipal();
		panelRegistroInteligenciaPrincipal_2.setImmediate(false);
		panelRegistroInteligenciaPrincipal_2.setWidth("-1px");
		panelRegistroInteligenciaPrincipal_2.setHeight("-1px");
		tabDocumento.addComponent(panelRegistroInteligenciaPrincipal_2);
