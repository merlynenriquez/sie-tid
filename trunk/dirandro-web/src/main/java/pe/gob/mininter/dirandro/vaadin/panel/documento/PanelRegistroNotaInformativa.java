...
public class PanelRegistroNotaInformativa extends DirandroComponent {
	...
	@AutoGenerated
	private CKEditorTextField cKEditorNota;
	@AutoGenerated
	...
	private void llenaNota(){
		if(notaInformativa!=null){
			...
			txtNumero.setValue(notaInformativa.getNumero());
	...
	private HorizontalLayout buildHorizontalLayout_5() {
		...
		// cKEditorNota
		cKEditorNota = new CKEditorTextField();
		cKEditorNota.setImmediate(false);
		cKEditorNota.setWidth("-1px");
		cKEditorNota.setHeight("-1px");
		horizontalLayout_5.addComponent(cKEditorNota);
