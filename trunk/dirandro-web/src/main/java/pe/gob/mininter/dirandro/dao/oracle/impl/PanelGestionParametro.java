...
public class PanelGestionParametro extends HarecComponent implements TextChangeListener, ClickListener {
	...
	public PanelGestionParametro(List<Opcion> acciones, String height) {
	...
	public void postConstruct() {
		...
		//txtADescripcion.setNullSettingAllowed(nullSettingAllowed)
		//tblParametro.set
		...
		tblParametro.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				else
				{
					...
					//BeanItem<Valor> valorSel = null;
					for (Valor estado : estados) {
						if(estado.getNombre().equals(estadoSel))
						{
							//valorSel = new BeanItem<Valor>(estado);
					...
					//Valor estado = (Valor) event.getItem().getItemProperty("estado");
					//BeanItem<Valor> valorSel = new BeanItem<Valor>(estado);
	...
	{
		/*BeanContainer<String, Parametro> container=new BeanContainer<String, Parametro>(Parametro.class);
		container.addNestedContainerProperty("estado.nombre");
		container.setBeanIdResolver(new BeanIdResolver<String, Parametro>() {

			private static final long serialVersionUID = -5477745751697471304L;
			
			@Override
			public String getIdForBean(Parametro bean) {
				return bean.getCodigo();
			}
			
		});
		container.addAll(parametros);
		container.setBeanIdProperty("codigo");*/
