...
public class PanelRegistroParte extends DirandroComponent implements ClickListener, SelectedTabChangeListener {
	...
	@AutoGenerated
	private VerticalLayout tabGroupInca;
	@AutoGenerated
	...
	@AutoGenerated
	private VerticalLayout tabGroupPerson;
	@AutoGenerated
	...
	private TabSheet buildTabSheet_1() {
		...
		// tabGroupPerson
		tabGroupPerson = buildTabGroupPerson();
		tabSheet_1.addTab(tabGroupPerson, "Personas", null);
		...
		tabSheet_1.addTab(verticalLayout_4, "Vehículos / Inmuebles", null);
		...
		// tabGroupInca
		tabGroupInca = buildTabGroupInca();
		tabSheet_1.addTab(tabGroupInca, "Especies", null);
		
		// tabGrupoArmas
		tabGrupoArmas = buildTabGrupoArmas();
		tabSheet_1.addTab(tabGrupoArmas, "Armas", null);
		
		return tabSheet_1;
	}

	@AutoGenerated
	private VerticalLayout buildTabGroupPerson() {
		// common part: create layout
		tabGroupPerson = new VerticalLayout();
		tabGroupPerson.setImmediate(false);
		tabGroupPerson.setWidth("-1px");
		tabGroupPerson.setHeight("-1px");
		tabGroupPerson.setMargin(false);
		
		// tabSheet_3
		tabSheet_3 = buildTabSheet_3();
		tabGroupPerson.addComponent(tabSheet_3);
		
		return tabGroupPerson;
	}
	...
	private TabSheet buildTabSheet_3() {
		...
		tabSheet_3.setWidth("-1px");
		tabSheet_3.setHeight("300px");
	...
	private VerticalLayout buildVerticalLayout_4() {
		...
		verticalLayout_4.addComponent(tabSheet_4);
	...
	private TabSheet buildTabSheet_4() {
		...
		tabSheet_4.setWidth("-1px");
		tabSheet_4.setHeight("-1px");
		
		// pnlInstalaciones
		pnlInstalaciones = buildPnlInstalaciones();
		tabSheet_4.addTab(pnlInstalaciones, "Instalaciones", null);
		
		// pnlInmuebles
		pnlInmuebles = buildPnlInmuebles();
		tabSheet_4.addTab(pnlInmuebles, "Inmiuebles", null);
		
		// pnlVehiculos
		pnlVehiculos = buildPnlVehiculos();
		tabSheet_4.addTab(pnlVehiculos, "Vehículos", null);
	...
	@AutoGenerated
	private VerticalLayout buildTabGroupInca() {
		// common part: create layout
		tabGroupInca = new VerticalLayout();
		tabGroupInca.setImmediate(false);
		tabGroupInca.setWidth("-1px");
		tabGroupInca.setHeight("-1px");
		tabGroupInca.setMargin(false);
		
		// tabSheet_Incautado
		tabSheet_Incautado = buildTabSheet_Incautado();
		tabGroupInca.addComponent(tabSheet_Incautado);
	...
	private TabSheet buildTabSheet_Incautado() {
		...
		tabSheet_Incautado.setWidth("-1px");
		...
		tabSheet_Incautado.addTab(pnlImporte, "Importes", null);
	...
	private HorizontalLayout buildPnlMunicionesBody1() {
		...
		pnlMunicionesBody1.addComponent(cbbMuniMarca);
	...
	private HorizontalLayout buildPnlMunicionesBody2() {
		...
		cbbMuniPersonaIncautada.setWidth("200px");
	...
	private HorizontalLayout buildPnlMunicionesBody3() {
		...
		txtMuniDescripcion.setWidth("700px");
	...
	private HorizontalLayout buildPnlMunicionesBody4() {
		...
		pnlMunicionesBody4.addComponent(cbbMuniTipoMedida);
	...
	private HorizontalLayout buildPnlMunicionesBody5() {
		...
		txtMuniObservacion.setHeight("100px");
