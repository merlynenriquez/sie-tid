...
public class PanelRegistroParte extends DirandroComponent implements ClickListener, SelectedTabChangeListener {
	...
	@AutoGenerated
	private PanelRegistroParteInstalacion pnlInstalacion;
	@AutoGenerated
	...
	private TabSheet buildTabSheet_4() {
		...
		// pnlInstalacion
		pnlInstalacion = new PanelRegistroParteInstalacion();
		pnlInstalacion.setImmediate(false);
		pnlInstalacion.setWidth("-1px");
		pnlInstalacion.setHeight("-1px");
		tabSheet_4.addTab(pnlInstalacion, "Instalaciones", null);
