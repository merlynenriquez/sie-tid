...
public class PanelRegistroParte extends HarecComponent implements  ClickListener {
	...
	@AutoGenerated
	private Button btnArmDuenioRegistrar;
	@AutoGenerated
	...
	private HorizontalLayout buildPnlTelefonosBody2() {
		...
		btnTelPersonaIncautadaRegistrar.setCaption("Registrar");
	...
	private HorizontalLayout buildPnlTelefonosBody3_1() {
		...
		btnDuenioRegistrar.setCaption("Registrar");
	...
	private HorizontalLayout buildPnlVehiculosBody2() {
		...
		btnVehPersonaIncautadaRegistrar.setCaption("Registrar");
		...
		btnVehPropietarioRegistrar.setCaption("Registrar");
	...
	private HorizontalLayout buildPnlMunicionesBody1() {
		...
		pnlMunicionesBody1.addComponent(cbbMuniPersonaIncautada);
	...
	private HorizontalLayout buildPnlMunicionesBody2() {
		...
		pnlMunicionesBody2.addComponent(txtMuniDescripcion);
		...
		pnlMunicionesBody2.addComponent(cbbMuniMarca);
	...
	private HorizontalLayout buildPnlArmasBody3() {
		...
		cbbArmPersonaIncautada.setWidth("250px");
		...
		pnlArmasBody3.addComponent(button_1);
		pnlArmasBody3.setComponentAlignment(button_1, new Alignment(9));
	...
	private HorizontalLayout buildPnlArmasBody4_1() {
		...
		cbbArmTipoDuenio.setWidth("150px");
		cbbArmTipoDuenio.setHeight("-1px");
		pnlArmasBody4_1.addComponent(cbbArmTipoDuenio);
		
		// cbbDuenio
		cbbDuenio = new ComboBox();
		cbbDuenio.setCaption("Dueño");
		cbbDuenio.setImmediate(false);
		cbbDuenio.setWidth("250px");
		cbbDuenio.setHeight("-1px");
		pnlArmasBody4_1.addComponent(cbbDuenio);
		
		// btnArmDuenioRegistrar
		btnArmDuenioRegistrar = new Button();
		btnArmDuenioRegistrar.setCaption("Registrar");
		btnArmDuenioRegistrar.setImmediate(true);
		btnArmDuenioRegistrar.setWidth("-1px");
		btnArmDuenioRegistrar.setHeight("-1px");
		pnlArmasBody4_1.addComponent(btnArmDuenioRegistrar);
		pnlArmasBody4_1.setComponentAlignment(btnArmDuenioRegistrar,
				new Alignment(24));
	...
	private HorizontalLayout buildPnlArmasBody5() {
		...
		txtArmObservacion.setWidth("270px");
		...
		pnlArmasBody5.addComponent(txtArmCantidad);
