...
public class PanelMantenPersona extends HarecComponent implements ClickListener, ValueChangeListener {
	...
	@AutoGenerated
	private Upload uploadImgAdjuntar;
	@AutoGenerated
	...
	private void inicializaPanelImagen(){
		// Display the image without caption
		 Embedded image = new Embedded("Imagen uno", new ThemeResource("img/ladron.jpg") );
	...
	private HorizontalLayout buildHorizontalLayout_6() {
		...
		// uploadImgAdjuntar
		uploadImgAdjuntar = new Upload();
		uploadImgAdjuntar.setImmediate(false);
		uploadImgAdjuntar.setWidth("-1px");
		uploadImgAdjuntar.setHeight("-1px");
		horizontalLayout_6.addComponent(uploadImgAdjuntar);
