...
public class PanelMantenPersona extends HarecComponent implements ClickListener {
	...
	public void inicializaPanelPersona(){
		...
		cmbPerPersonaVerdadera.setContainerDataSource(  new BeanItemContainer<Persona>(Persona.class,  lPersonas)  );
	...
	private VerticalLayout buildVerticalLayout_8() {
		...
		tblPerPersonas.setHeight("150px");
	...
	private VerticalLayout buildVerticalLayout_10() {
		...
		verticalLayout_10.addComponent(horizontalLayout_9);
	...
	private HorizontalLayout buildHorizontalLayout_9() {
		...
		horizontalLayout_9.addComponent(txtPerNombres);
		...
		horizontalLayout_9.addComponent(txtPerApePaterno);
		...
		horizontalLayout_9.addComponent(txtPerApeMaterno);
	...
	private HorizontalLayout buildPnlPersona2() {
		...
		pnlPersona2.addComponent(dtPerNacimiento);
