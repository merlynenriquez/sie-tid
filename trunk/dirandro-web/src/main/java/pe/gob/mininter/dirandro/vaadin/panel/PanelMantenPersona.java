...
public class PanelMantenPersona extends HarecComponent implements ClickListener {
	...
	private List<Valor> lTipoParentescos;
	...
	private boolean flagNuevaPersona, flagNuevoDetalle, flagNuevoCorreo, flagNuevaDireccion, flagNuevoParentezco;
		...
		tblPerPersonas.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(esModoNuevo){
					...
					lparentescos = parentescoService.obtenerParientesXPersona( persona.getId() , true);
	...
	public void inicializaPanelParentesco(){
		...
		lTipoParentescos = valorService.obtenerLista(Constante.LISTA.CODIGO.PARENTESCO);
		
		cmbParTipoParentesco.setInputPrompt("Tipo de Parentesco");
		cmbParTipoParentesco.setItemCaptionPropertyId("nombre");
		cmbParTipoParentesco.setContainerDataSource(new BeanItemContainer<Valor>(Valor.class,  lTipoParentescos ));
		 
		cmbParPariente.setInputPrompt("Pariente");
		cmbParPariente.setItemCaptionPropertyId("nombreCompleto");
		cmbParPariente.setContainerDataSource(new BeanItemContainer<Persona>(Persona.class,  lPersonas ));
	...
	private void cargarListasParentesco(List<Parentesco> parentescos, boolean flagLimpiar)
	{
         ...
         for (Parentesco lista: parentescos) {
			     ...
			     item.getItemProperty("Nombre").setValue(lista.getPariente().getNombres());
