...
public class AlertDialog extends Window {
	...
	private static final long serialVersionUID = -4873956349727083619L;
	...
	public AlertDialog() {
		...
		btnAlerta.addListener(new ClickListener() {
			
			/**
			 * 
			 */
			private static final long serialVersionUID = -948368732813295959L;

			@Override
			public void buttonClick(ClickEvent event) {
				Window windowHarec=(Window)getParent();
				windowHarec.getWindow().removeWindow(window);
			}
		});
