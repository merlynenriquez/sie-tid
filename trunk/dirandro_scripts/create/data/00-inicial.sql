...
---razgos
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (105,12,'CEJA_POB','Cejas Pobladas','Cejas Pobladas',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (106,13,'OREJA_PT','Orejas Punteagudas','Orejas Punteagudas',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (107,14,'PIEL_CL','Piel Clara','Piel Clara',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (108,15,'CONTEX_GR','Contextura Gruesa','Contextura Gruesa',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (109,16,'CABELLO_LZ','Cabello Lazio','Cabello Lazio',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (110,17,'RAZA_MZ','Raza Mestiza','Raza Mestiza',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (111,18,'CABELLO_RB','Cabello Rubio','Cabello Rubio',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (112,19,'CORTE_ML','Corte Militar','Corte Militar',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (113,20,'OJO_RD','Ojos Redondos','Ojos Redondos',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (114,21,'OJO_PR','Pardos','Pardos',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (115,22,'NARIZ_AG','Nariz Aguileña','Nariz Aguileña',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (116,23,'CARA_RD','Cara Redonda','Cara Redonda',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (117,24,'LABIO_GR','Labio Grueso','Labio Grueso',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (118,25,'BOCA_NR','Boca Normal','Boca Normal',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (119,26,'PROF_ADM','Administrados','Administrador',1,'A',1,SYSDATE);

INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (120,27,'PAR_HER','Hermano','Hermano',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (121,27,'PAR_PRI','Primo','Primo',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (122,27,'PAR_TIO','Tio','Tio',1,'A',1,SYSDATE);
INSERT INTO SIETID.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) VALUES (123,27,'PAR_SOB','Sobrino','Sobrino',1,'A',1,SYSDATE);
