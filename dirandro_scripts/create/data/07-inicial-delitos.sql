...
--Tabla de Padres
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (1, null, 'DELITOS CONTRA LA VIDA EL CUERPO Y LA SALUD', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (2, null, 'DELITOS CONTRA EL HONOR', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (3, null, 'DELITO CONTRA LA FAMILIA', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (4, null, 'DELITOS CONTRA LA LIBERTAD', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (5, null, 'DELITOS CONTRA EL PATRIMONIO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (6, null, 'DELITOS CONTRA LA CONFIANZA Y LA BUENA FE EN LOS NEGOCIOS', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (7, null, 'DELITOS CONTRA LOS DERECHOS INTELECTUALES', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (8, null, 'DELITOS CONTRA EL PATRIMONIO CULTURAL', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (9, null, 'DELITOS CONTRA EL ORDEN ECONÓMICO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (10, null, 'DELITOS CONTRA EL ORDEN FINANCIERO Y MONETARIO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (11, null, 'DELITOS TRIBUTARIOS', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (12, null, 'DELITOS CONTRA LA SEGURIDAD PÚBLICA', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (13, null, 'DELITOS AMBIENTALES', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (14, null, 'DELITOS CONTRA LA TRANQUILIDAD PÚBLICA', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (15, null, 'DELITOS CONTRA LA HUMANIDAD', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (16, null, 'DELITOS CONTRA EL ESTADO Y LA DEFENSA NACIONAL', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (17, null, 'DELITOS CONTRA LOS PODERES DEL ESTADO Y EL ORDEN CONSTITUCIONAL', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (18, null, 'DELITOS CONTRA LA VOLUNTAD POPULAR', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (19, null, 'DELITOS CONTRA LA ADMINISTRACIÓN PÚBLICA', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (20, null, 'DELITOS CONTRA LA FE PÚBLICA', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (21, null, 'DESAPARECIDOS', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (22, null, 'FALTAS', 1, 206, 1, SYSDATE);

INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (23, 1, 'HOMICIDIO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (24, 1, 'ABORTO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (25, 1, 'LESIONES', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION) VALUES (26, 1, 'EXPOSICIÓN A PELIGRO O ABANDONO DE PERSONAS EN PELIGRO', 1, 206, 1, SYSDATE);
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (27, 23, 'HOMICIDIO SIMPLE', 1, 206, 1, SYSDATE,  'Artículo 106.- Homicidio Simple 
El que mata a otro será reprimido con pena privativa de libertad no menor de seis ni mayor de 
veinte años.');
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (28, 23, 'PARRICIDIO', 1, 206, 1, SYSDATE,  'Artículo 107.- Parricidio 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (29, 23, 'ASESINATO', 1, 206, 1, SYSDATE,  'Artículo 108.- Homicidio Calificado - Asesinato 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (30, 23, 'HOMICIDIO POR EMOCIÓN VIOLENTA', 1, 206, 1, SYSDATE,  'Artículo 109.- Homicidio por emoción violenta 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (31, 23, 'INFANTICIDIO', 1, 206, 1, SYSDATE,  'Artículo 110.- Infanticidio 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (32, 23, 'HOMICIDIO CULPOSO', 1, 206, 1, SYSDATE,  'Artículo 111.- Homicidio Culposo 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (33, 23, 'HOMICIDIO PIADOSO', 1, 206, 1, SYSDATE,  'Artículo 112.- Homicidio piadoso 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (34, 23, 'INSTIGACIÓN O AYUDA AL SUICIDIO', 1, 206, 1, SYSDATE,  'Artículo 113.- Instigación o ayuda al suicidio 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (35, 24, 'AUTOABORTO', 1, 206, 1, SYSDATE,  'Artículo 114.- Autoaborto 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (36, 24, 'ABORTO CONSENTIDO', 1, 206, 1, SYSDATE,  'Artículo 115.- Aborto consentido 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (37, 24, 'ABORTO NO CONSENTIDO', 1, 206, 1, SYSDATE,  'Artículo 116.- Aborto sin consentimiento 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (38, 24, 'ABORTO AGRAVADO POR LA CUALIFICACIÓN DEL SUJETO ACTIVO', 1, 206, 1, SYSDATE,  'Artículo 117.- Agravación de la pena por la calidad del sujeto 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (39, 24, 'ABORTO PRETERINTENCIONAL', 1, 206, 1, SYSDATE,  'Artículo 118.- Aborto preterintencional 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (40, 24, 'ABORTO TERAPÉUTICO IMPUNE', 1, 206, 1, SYSDATE,  'Artículo 119.- Aborto terapeútico 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (41, 24, 'ABORTO SENTIMENTAL Y EUGENÉSICO', 1, 206, 1, SYSDATE,  'Artículo 120.- Aborto sentimental y eugenésico 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (42, 25, 'LESIONES GRAVES', 1, 206, 1, SYSDATE,  'Artículo 121.- Lesiones graves 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (44, 25, 'LESIONES LEVES', 1, 206, 1, SYSDATE,  'Artículo 122.- Lesiones leves 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (46, 25, 'LESIONES CON RESULTADO FORTUITO', 1, 206, 1, SYSDATE,  'Artículo 123.- Lesiones preterintencionales con resultado fortuito 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (47, 25, 'LESIONES CULPOSAS', 1, 206, 1, SYSDATE,  'Artículo 124.- Lesiones Culposas El que por culpa causa a otro un daño en el cuerpo o en la salud, será reprimido, por acción privada, con pena privativa de libertad no mayor de un año y con sesenta a ciento veinte días-multa.
La acción penal se promoverá de oficio y la pena será privativa de libertad no menor de uno ni mayor de dos años y de sesenta a ciento veinte días-multa, si la lesión es grave. (*)
(*) Párrafo modificado por el Artículo 1 de la Ley N° 29439, publicada el 19 noviembre 2009, cuyo texto es el siguiente:
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (48, 26, 'EXPOSICIÓN O ABANDONO A PERSONAS INCAPACES', 1, 206, 1, SYSDATE,  'Artículo 125.- Exposición o abandono peligrosos El que expone a peligro de muerte o de grave e inminente daño a la salud o abandona en iguales circunstancias a un menor de edad o a una persona incapaz de valerse por sí misma que estén legalmente bajo su protección o que se hallen de hecho bajo su cuidado, será reprimido con pena privativa de libertad no menor de uno ni mayor de cuatro años.');
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (49, 26, 'OMISIÓN DE SOCORRO Y EXPOSICIÓN AL PELIGRO', 1, 206, 1, SYSDATE,  'Artículo 126.- Omisión de socorro y exposición a peligro 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (50, 26, 'OMISIÓN DE AUXILIO A PERSONA EN PELIGRO O AVISO A LA AUTORIDAD', 1, 206, 1, SYSDATE,  'Artículo 127.- Omisión de auxilio o aviso a la autoridad 
...
INSERT INTO EXP_DELITO (ID, PADRE, NOMBRE, ESTADO, TIPO_CODIGO, CREADOR, CREACION, OBSERVACION) VALUES (51, 26, 'EXPOSICIÓN A PELIGRO DE PERSONA DEPENDIENTE', 1, 206, 1, SYSDATE,  'Artículo 128.- Exposición a peligro de persona dependiente El que expone a peligro la vida o la salud de una persona colocada bajo su autoridad, dependencia, tutela, curatela o vigilancia, sea privándola de alimentos o cuidados indispensables, sea sometiéndola a trabajos excesivos, inadecuados, sea abusando de los medios de corrección o disciplina, sea obligándola o induciéndola a mendigar en lugares públicos, será reprimido con pena privativa de libertad no menor de uno ni mayor de cuatro años.
