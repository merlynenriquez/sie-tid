...
(
   ...
   TIPO_INHABILITACION  NUMBER(16),
   NRO_ANO_INHABILITADO NUMBER(16),
   NRO_MES_INHABILITADO NUMBER(16),
   NRO_DIA_INHABILITADO NUMBER(16),
...
alter table SIETID.PER_SITUACION_PROCESO
   add constraint FK_PER_PROCESO_TIPO_INHABILI foreign key (TIPO_INHABILITACION)
      references SIETID.CFG_VALOR (ID);
