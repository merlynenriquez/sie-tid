...
import pe.gob.mininter.dirandro.vaadin.panel.util.DependenciaSelector;
...
public class PanelRegistroParteDocumento extends CustomComponent implements ClickListener, DependenciaSelector {
	...
	public void setDependencia(Dependencia dependencia) {
		...
		this.lblDependencia.setValue(dependencia.getNombre());
	}
	...
	public void buttonClick(ClickEvent event) {
		...
		if(event.getButton().equals(btnDependencia)){
			...
			panelDependencia.setPadre(this);
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		horizontalLayout_1.addComponent(lblDependencia);
