...
public class PanelBandejaHojaRemision extends DirandroComponent implements TablaFiltroEnterListener, ClickListener {
	...
	public void postConstruct() {
		...
		btnPericias.addListener((ClickListener) this);
	...
	public void buttonClick(ClickEvent event) {
		...
		if(event.getButton().equals(btnPericias)) {
			//Object objID = tblBandeja.getValue();
	...
	private HorizontalLayout buildLytBotonera() {
		...
		// btnPericias
		btnPericias = new Button();
		btnPericias.setCaption("Ver Pericas");
		btnPericias.setImmediate(false);
		btnPericias.setWidth("-1px");
		btnPericias.setHeight("-1px");
		lytBotonera.addComponent(btnPericias);
