...
public class Estado extends AuditoriaBean implements Validador, Serializable {
	...
	public void validar() {
		if(StringUtils.isBlank(codigo)){
			throw new ValidacionException(Constante.CODIGO_MENSAJE.VALIDAR_TEXTBOX, new Object[]{"Código Representativo"});
		}
		if(StringUtils.isBlank(nombre)){
			throw new ValidacionException(Constante.CODIGO_MENSAJE.VALIDAR_TEXTBOX, new Object[]{"Nombre del Estado"});
		}
