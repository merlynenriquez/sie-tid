...
public class PanelRegistroParteInstalacion extends CustomComponent implements ClickListener {
	...
	@AutoGenerated
	private ComboBox cmbZonaDeProduccion;
	@AutoGenerated
	...
	private void cargarTablaInstalaciones( ){
		...
		tblInstalaciones.setVisibleColumns(new Object[]{"tipo.nombre", "nombre", "organizacion.nombre"});
//	
...
//				
	...
	public void limpiar(){
		...
		cmbZonaDeProduccion.select(null);
	}
	...
	private HorizontalLayout buildHorizontalLayout_29() {
		...
		// cmbZonaDeProduccion
		cmbZonaDeProduccion = new ComboBox();
		cmbZonaDeProduccion.setCaption("Zona de Produccion");
		cmbZonaDeProduccion.setImmediate(false);
		cmbZonaDeProduccion.setWidth("-1px");
		cmbZonaDeProduccion.setHeight("-1px");
		horizontalLayout_29.addComponent(cmbZonaDeProduccion);
