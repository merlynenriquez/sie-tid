...
public class PanelRegistroCasoInterviniente extends CustomComponent implements ClickListener, PanelAgregarPersonaListener, PanelAgregarEmpresaListener {
	...
	private void buttonClickBtnRIAgregar() {
		...
		if (rbTipoInterviniente.getValue().equals(OPCION_PERSONA)) {
			detExpedientePersona.setInvolucrado((Persona) cmbIntervinientes
					.getValue());
		} else {
			detExpedientePersona
					.setEmpresaInvolucrada((Empresa) cmbIntervinientes
							.getValue());
		}
