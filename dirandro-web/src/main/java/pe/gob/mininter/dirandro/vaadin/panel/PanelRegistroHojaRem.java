...
public class PanelRegistroHojaRem extends DirandroComponent implements ClickListener{
	...
	private VerticalLayout buildPnlHoja() {
		...
		pnlHoja.addComponent(horizontalLayout_4);
	...
	private HorizontalLayout buildLytOrigen() {
		...
		cmbDireccionOrigen.setWidth("200px");
		...
		cmbDivisionOrigen.setWidth("200px");
		...
		cmbDepartamentoOrigen.setWidth("200px");
	...
	private HorizontalLayout buildLytDestino() {
		...
		cmbDireccionDestino.setWidth("200px");
		...
		cmbDivisionDestino.setWidth("200px");
		...
		cmbDepartamentoDestino.setWidth("200px");
	...
	private VerticalLayout buildPnlDetalle() {
		...
		pnlDetalle.addComponent(verticalLayout_4);
	...
	private HorizontalLayout buildHorizontalLayout_8() {
		...
		txtpesoanalisis.setWidth("150px");
		...
		txtxpesodevuelto.setWidth("150px");
		...
		txtcantidadlavadoAct.setWidth("150px");
		txtcantidadlavadoAct.setHeight("-1px");
		txtcantidadlavadoAct.setInputPrompt("Cantidad Lavado Activos");
