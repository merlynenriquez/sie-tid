...
public class PanelRegistroParte extends DirandroComponent implements ClickListener, SelectedTabChangeListener {
	...
	@AutoGenerated
	private PanelRegistroParteDelito panelRegistroParteDelito_1;
	@AutoGenerated
	...
	private VerticalLayout buildPnlDelitos() {
		...
		// panelRegistroParteDelito_1
		panelRegistroParteDelito_1 = new PanelRegistroParteDelito();
		panelRegistroParteDelito_1.setImmediate(false);
		panelRegistroParteDelito_1.setWidth("-1px");
		panelRegistroParteDelito_1.setHeight("-1px");
		pnlDelitos.addComponent(panelRegistroParteDelito_1);
