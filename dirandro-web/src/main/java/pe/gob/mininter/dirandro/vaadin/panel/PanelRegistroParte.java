...
public class PanelRegistroParte extends DirandroComponent implements ClickListener, SelectedTabChangeListener {
	...
	private TabSheet buildTabSheet_4() {
		...
		tabSheet_4.addTab(pnlInmuebles, "Inmuebles", null);
	...
	private VerticalLayout buildPnlInstalaciones() {
		...
		pnlInstalaciones.setWidth("100.0%");
		pnlInstalaciones.setHeight("632px");
	...
	private VerticalLayout buildPnlInmuebles() {
		...
		pnlInmuebles.setWidth("100.0%");
		pnlInmuebles.setHeight("632px");
	...
	private VerticalLayout buildPnlVehiculos() {
		...
		pnlVehiculos.setWidth("100.0%");
		pnlVehiculos.setHeight("632px");
