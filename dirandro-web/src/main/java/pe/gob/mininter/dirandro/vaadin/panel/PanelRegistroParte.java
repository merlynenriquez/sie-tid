...
public class PanelRegistroParte extends DirandroComponent implements ClickListener, SelectedTabChangeListener {
	...
	@AutoGenerated
	private PanelRegistroParteInmueble pnlInmueble;
	@AutoGenerated
	...
	private TabSheet buildTabSheet_4() {
		...
		// pnlInmueble
		pnlInmueble = new PanelRegistroParteInmueble();
		pnlInmueble.setImmediate(false);
		pnlInmueble.setWidth("-1px");
		pnlInmueble.setHeight("-1px");
		tabSheet_4.addTab(pnlInmueble, "Inmueble", null);
