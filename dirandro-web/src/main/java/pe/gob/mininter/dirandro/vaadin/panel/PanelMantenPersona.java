...
public class PanelMantenPersona extends HarecComponent implements ClickListener {
	...
	@AutoGenerated
	private ComboBox cmbParNacionalidad;
	@AutoGenerated
	private TextField txtParNumero;
	@AutoGenerated
	private ComboBox cmbParTipoDoc;
	@AutoGenerated
	...
	public void inicializaPanelPersona(){
		...
		cmbPerEstadoCivil.setContainerDataSource(new BeanItemContainer<Valor>(Valor.class,  valorService.obtenerLista(Constante.LISTA.CODIGO.ESTADO_CIVIL) ));
	...
	public void inicializaPanelParentezco(){
	...
	public void registrarPersona(){
		...
		per.setApeMaterno( txtPerApeMaterno.getValue().toString() );
		per.setApePaterno( txtPerApePaterno.getValue().toString() );
		per.setEstadoCivil( null );
		per.setFecNacimiento( null );
		per.setNacionalidad( null );
		per.setNombres( txtPerNombres.getValue().toString() );
		per.setNroDocumento( txtPerNumDoc.getValue().toString() );
		per.setOrientacionSexual( null );
		per.setSexo( rbPerSexo.getValue().toString() );
		per.setTipoDocumento( null );
		per.setUbgDistrito( null );
		try {
			logger.debug( "inserta persona " );
	...
	private VerticalLayout buildVerticalLayout_8() {
		...
		table_2.setWidth("800px");
		table_2.setHeight("150px");
		verticalLayout_8.addComponent(table_2);
	...
	private HorizontalLayout buildPnlPersona1() {
		...
		cmbPerNacionalidad.setWidth("-1px");
		cmbPerNacionalidad.setHeight("-1px");
		pnlPersona1.addComponent(cmbPerNacionalidad);
	...
	private HorizontalLayout buildHorizontalLayout_7() {
		...
		horizontalLayout_7.setWidth("525px");
		horizontalLayout_7.setHeight("-1px");
		horizontalLayout_7.setMargin(false);
		
		// cmbParTipoDoc
		cmbParTipoDoc = new ComboBox();
		cmbParTipoDoc.setCaption("Tipo Doc");
		cmbParTipoDoc.setImmediate(false);
		cmbParTipoDoc.setWidth("-1px");
		cmbParTipoDoc.setHeight("-1px");
		horizontalLayout_7.addComponent(cmbParTipoDoc);
		...
		horizontalLayout_7.addComponent(txtParNumero);
		
		// cmbParNacionalidad
		cmbParNacionalidad = new ComboBox();
		cmbParNacionalidad.setCaption("Nacionalidad");
		cmbParNacionalidad.setImmediate(false);
		cmbParNacionalidad.setWidth("-1px");
		cmbParNacionalidad.setHeight("-1px");
		horizontalLayout_7.addComponent(cmbParNacionalidad);
	...
	private HorizontalLayout buildHorizontalLayout_4() {
		...
		horizontalLayout_4.setWidth("565px");
		...
		horizontalLayout_4.addComponent(button_5);
		horizontalLayout_4.setComponentAlignment(button_5, new Alignment(10));
