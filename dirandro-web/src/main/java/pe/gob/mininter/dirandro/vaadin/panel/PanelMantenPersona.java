...
public class PanelMantenPersona extends HarecComponent implements ClickListener {
	...
	private boolean flagNuevaPersona, flagNuevoDetalle, flagNuevoCorreo, flagNuevaDireccion;
		...
		tblPerPersonas.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(esModoNuevo){
					...
					lCorreos = correoService.obtenerCorreosXPersona( persona.getId() ,  true );
	...
	public void llenaPanelDetalle(){
		...
		if( detalle != null ){
			...
			txaDetSenias.setValue( detalle.getSenas() );
			txaDetVestimenta.setValue( detalle.getVestimenta() ); 
			txaDetUltVisto.setValue( detalle.getFechalugarUltvez() );
	...
	public void llenarCamposDireccion( Direccion direccion ){
		...
		cmbDirDistrito.setValue( direccion.getUbgDistrito() );    
	}
	...
	private void registrarDireccion(){
		...
		limpiar("distrito");
		lDirecciones = direccionService.obtenerDireccionesXPersona( persona.getId() , true );
		llenaPanelDirecciones();
	}
	...
	private VerticalLayout buildVerticalLayout_5() {
		...
		tblDirDirecciones.setWidth("585px");
		tblDirDirecciones.setHeight("-1px");
	...
	private HorizontalLayout buildHorizontalLayout_4() {
		...
		horizontalLayout_4.addComponent(txtDirDireccion);
		...
		horizontalLayout_4.addComponent(btnDirAgregar);
		horizontalLayout_4.setComponentAlignment(btnDirAgregar, new Alignment(
				10));
	...
	private VerticalLayout buildVerticalLayout_6() {
		...
		tblCorrCorreos.setWidth("505px");
		tblCorrCorreos.setHeight("-1px");
