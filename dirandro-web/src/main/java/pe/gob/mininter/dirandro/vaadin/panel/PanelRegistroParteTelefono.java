...
public class PanelRegistroParteTelefono extends CustomComponent implements ClickListener {
	...
	@AutoGenerated
	private HorizontalLayout pnlTelefonos3;
	@AutoGenerated
	...
	@AutoGenerated
	private Button btnTelRegistrarEquipo;
	@AutoGenerated
	...
	public void buttonClick(ClickEvent event) {
		if(event.getButton().equals(btnTelRegistrarEquipo)){
	...
	private VerticalLayout buildPnlPrincipal() {
		...
		// pnlTelefonos3
		pnlTelefonos3 = buildPnlTelefonos3();
		pnlPrincipal.addComponent(pnlTelefonos3);
	...
	private HorizontalLayout buildPnlTelefonos1() {
		...
		cmbEquipo.setWidth("-1px");
		cmbEquipo.setHeight("-1px");
		pnlTelefonos1.addComponent(cmbEquipo);
		
		// btnTelRegistrarEquipo
		btnTelRegistrarEquipo = new Button();
		btnTelRegistrarEquipo.setCaption("Registrar Equipo");
		btnTelRegistrarEquipo.setImmediate(true);
		btnTelRegistrarEquipo.setWidth("-1px");
		btnTelRegistrarEquipo.setHeight("-1px");
		pnlTelefonos1.addComponent(btnTelRegistrarEquipo);
		pnlTelefonos1.setComponentAlignment(btnTelRegistrarEquipo,
				new Alignment(10));
		...
		pnlTelefonos1.addComponent(cmbOperadora);
	...
	private HorizontalLayout buildPnlTelefonos2() {
		...
		cmbPersonaImplicada.setWidth("270px");
	...
	@AutoGenerated
	private HorizontalLayout buildPnlTelefonos3() {
		// common part: create layout
		pnlTelefonos3 = new HorizontalLayout();
		pnlTelefonos3.setImmediate(false);
		pnlTelefonos3.setWidth("-1px");
		pnlTelefonos3.setHeight("-1px");
		pnlTelefonos3.setMargin(false);
		pnlTelefonos3.setSpacing(true);
		
		// txaObservacion
		txaObservacion = new TextArea();
		txaObservacion.setImmediate(false);
		txaObservacion.setWidth("810px");
		txaObservacion.setHeight("70px");
		txaObservacion.setInputPrompt("Observaciones adicionales al Detalle");
		pnlTelefonos3.addComponent(txaObservacion);
		...
		pnlTelefonos3.addComponent(btnRegistrar);
		pnlTelefonos3.setComponentAlignment(btnRegistrar, new Alignment(10));
		
		return pnlTelefonos3;
	}
}
