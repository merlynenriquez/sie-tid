...
public class DependenciaComponent extends CustomComponent  implements ClickListener{
...
//			padre.setDependencia(dependenciaSeleccionada);
//		}
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		btnSeleccionar.setCaption("Button");
		btnSeleccionar.setImmediate(false);
		btnSeleccionar.setWidth("-1px");
		btnSeleccionar.setHeight("-1px");
		verticalLayout_2.addComponent(btnSeleccionar);
