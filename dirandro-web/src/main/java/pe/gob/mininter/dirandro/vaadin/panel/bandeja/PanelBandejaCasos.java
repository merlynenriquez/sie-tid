...
public class PanelBandejaCasos extends DirandroComponent implements TablaFiltroEnterListener, ClickListener {
	...
	public static final String COLUMNA_NOMBRE_CASO= "tipoMuestra";
	public static final String COLUMNA_NOMBRE_CASO_NOMBRE= "tipoMuestraNombre";
	public static final String COLUMNA_NOMBRE_CASO_DESCRIPCION= "tipoMuestraDesc";
	//Pericia
	public static final String COLUMNA_ID = "id";
	public static final String COLUMNA_ESTADO = "estado";
	public static final String COLUMNA_FECHA_PERICIA = "fechaPericia";
	public static final String COLUMNA_CASO = "pericia";
	...
	public void postConstruct() {
		...
		container.addContainerProperty(COLUMNA_NOMBRE_CASO_NOMBRE, String.class, StringUtils.EMPTY, "Muestra", TipoComponente.TEXT, true, 180);
		container.addContainerProperty(COLUMNA_ESTADO, String.class, StringUtils.EMPTY, "Estado", TipoComponente.TEXT, true, 120);
		container.addContainerProperty(COLUMNA_FECHA_PERICIA, String.class, StringUtils.EMPTY, "Fecha", TipoComponente.DATEPICKER, true, 180);
...
//				item.getItemProperty(COLUMNA_NOMBRE_CASO_NOMBRE).setValue(peri.getMuestra().getDroga()!=null? HarecUtil.marcaModeloNombreToEmpty( peri.getMuestra().getDroga().getTipoDroga() ) : peri.getMuestra().getEspecie().getNombre());
//				//item.getItemProperty(COLUMNA_NOMBRE_CASO_DESCRIPCION).setValue(peri.getMuestra().getDescripcion());
