...
public class PanelRegistroParteMunicion extends CustomComponent implements ClickListener {
	...
	public void postConstruct() {
		...
		cmbMuniTipo.addListener(new Property.ValueChangeListener() {            
            ...
            public void valueChange(com.vaadin.data.Property.ValueChangeEvent event) {				 
				lstMarcas = null;
				if(cmbMuniTipo.getValue() == null){
					lstMarcas = new ArrayList<ModeloMarca>();
				}else{
					ModeloMarca modeloMarca = new ModeloMarca();
					modeloMarca.setPadre((ModeloMarca)cmbMuniTipo.getValue());
					lstMarcas = modeloMarcaService.buscar(modeloMarca);
				}
		...
		cmbMuniMarca.setImmediate(true);
		cmbMuniMarca.addListener(new Property.ValueChangeListener() {            
			private static final long serialVersionUID = 1L;
			@Override
            public void valueChange(com.vaadin.data.Property.ValueChangeEvent event) {				 
				lstModelos = null;
				if(cmbMuniMarca.getValue() == null){
					lstModelos = new ArrayList<ModeloMarca>();
				}else{
					ModeloMarca modeloMarca = new ModeloMarca();
					modeloMarca.setPadre((ModeloMarca)cmbMuniMarca.getValue());
					lstModelos = modeloMarcaService.buscar(modeloMarca);
				}
	...
	private void rbTipoPersonaValueChange(ValueChangeEvent event){		
		...
		if(opcion){
			//cmbMuniPersonaIncautada.setVisible(false);
			//cambiar el origen del combo
		}
	...
	public void buttonClick(ClickEvent event) {
		...
		//	municion.setEmpresaPropietaria(new BigDecimal(1));
			...
			//municion.setTipo((ModeloMarca)cmbMuniTipo.getValue());
